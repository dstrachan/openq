        ...
        state: switch (State.start) {
            ...
            .dot => {
                ...
                switch (self.buffer[self.index]) {
                    ...
                    '_' => if (self.mode == .q) continue :state .invalid,
                    else => {},
                }
            },
...
test "tokenize symbols" {
    ...
    try testTokenizeMode(.q, "`_symbol_with_leading_underscore", &.{
        .{ .symbol_literal, "`" },
        .{ .underscore, "_" },
        .{ .identifier, "symbol_with_leading_underscore" },
    });
}
...
test "tokenize identifiers" {
    ...
    try testTokenizeMode(.k, "identifier.with.dot_and_underscore", &.{
        .{ .identifier, "identifier.with.dot" },
        .{ .underscore, "_" },
        .{ .identifier, "and" },
        .{ .underscore, "_" },
        .{ .identifier, "underscore" },
    });
    try testTokenizeMode(.q, "identifier.with.dot_and_underscore", &.{.{ .identifier, "identifier.with.dot_and_underscore" }});
    try testTokenize(".identifier.with.leading.dot", &.{.{ .identifier, ".identifier.with.leading.dot" }});
    try testTokenizeMode(.k, ".identifier.with.leading.dot_and_underscore", &.{
        .{ .identifier, ".identifier.with.leading.dot" },
        .{ .underscore, "_" },
        .{ .identifier, "and" },
        .{ .underscore, "_" },
        .{ .identifier, "underscore" },
    });
    try testTokenizeMode(.q, ".identifier.with.leading.dot_and_underscore", &.{.{ .identifier, ".identifier.with.leading.dot_and_underscore" }});
    try testTokenizeMode(.k, "._identifier.with.leading._dot_and_leading_underscore", &.{
        .{ .dot, "." },
        .{ .underscore, "_" },
        .{ .identifier, "identifier.with.leading." },
        .{ .underscore, "_" },
        .{ .identifier, "dot" },
        .{ .underscore, "_" },
        .{ .identifier, "and" },
    ...
    try testTokenizeMode(.q, "._identifier.with.leading._dot_and_leading_underscore", &.{
        .{ .invalid, "._identifier.with.leading._dot_and_leading_underscore" },
    });
    try testTokenizeMode(.k, ".identifier.with.leading._dot_and_leading_underscore_after_first_dot", &.{
        .{ .identifier, ".identifier.with.leading." },
        .{ .underscore, "_" },
        .{ .identifier, "dot" },
        .{ .underscore, "_" },
    ...
    try testTokenizeMode(.q, ".identifier.with.leading._dot_and_leading_underscore_after_first_dot", &.{
        .{ .identifier, ".identifier.with.leading._dot_and_leading_underscore_after_first_dot" },
    });
    ...
    try testTokenizeMode(.q, "identifier_with_underscore", &.{.{ .identifier, "identifier_with_underscore" }});
...
fn testTokenizeMode(mode: Mode, source: [:0]const u8, expected_values: []const struct { Token.Tag, []const u8 }) !void {
    ...
    var actual_tags: std.ArrayList(Token.Tag) = .empty;
    ...
    var expected_tags: std.ArrayList(Token.Tag) = .empty;
